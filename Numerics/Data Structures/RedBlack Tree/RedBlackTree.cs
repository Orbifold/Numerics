...
namespace Orbifold.Numerics
{
	...
	public class RedBlackTree<TKey, TValue> : RedBlackTree<KeyValuePair<TKey, TValue>>, IDictionary<TKey, TValue>
	{
		/// <summary>
		...
		{
			return this.Contains(new KeyValuePair<TKey, TValue>(key, default(TValue)), false);
		}
		...
		{
			var node = this.FindNode(new KeyValuePair<TKey, TValue>(key, default(TValue)));
